                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="ml-auto">
                                        <a v-if="authorize('modify', question)" @click.prevent="edit" class="btn btn-sm btn-outline-info">수정</a>
                                        <button v-if="authorize('deleteQuestion', question)"  @click="destroy" class="btn btn-sm btn-outline-danger">삭제</button>
                                    </div>
                                </div>
                                <div class="col-4"></div>
                                <div class="col-4">
